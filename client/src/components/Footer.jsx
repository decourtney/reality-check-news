...
const Footer = () => {
  return (
    // Replace mt-auto with fixed bottom-0 for Sticky footer
    <footer className="footer flex-col mt-auto w-full bg-gray-800 text-white py-6 text-center justify-center">
